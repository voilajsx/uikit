/**
 * Neon theme preset - electric green cyberpunk colors
 * @description High-tech, electric green theme perfect for gaming, tech, and modern creative applications
 * @package @voilajsx/uikit
 * @file /src/themes/presets/neon.js
 */

/**
 * Neon theme preset - electric green cyberpunk design with glowing accents
...
const neonTheme = {
  ...
  name: 'Neon',
  description:
    'Electric green cyberpunk theme with glowing accents for gaming and high-tech applications',

  // Enhanced design tokens for green cyberpunk aesthetic
  design: {
    ...
    radiusEnhance: '0.5rem', // Sharp cyberpunk corners
    spacingEnhance: '1.1',
    ...
    gradientPrimary: 'linear-gradient(135deg, oklch(0.29 0.035 150) 0%, oklch(0.42 0.05 150) 100%)', // 30% darker start to your green
    ...
    gradientHover: 'linear-gradient(135deg, oklch(0.45 0.055 150) 0%, oklch(0.31 0.04 150) 100%)', // Hover - flipped gradient pattern
    gradientText: 'linear-gradient(135deg, oklch(0.42 0.05 150) 0%, oklch(0.64 0.08 120) 70%, oklch(0.75 0.06 140) 100%)',
    gradientHoverDark: 'linear-gradient(135deg, oklch(0.55 0.09 150) 0%, oklch(0.38 0.06 150) 100%)', // Dark mode flipped hover
  ...
  // Custom CSS for green cyberpunk styling
  customStyles: `
    /* Import cyberpunk fonts - Google Fonts fallback for compatibility */
    ...
    .theme-neon [data-slot="heading"] {
      font-family: var(--voila-font-display);
      text-transform: uppercase;
      letter-spacing: 0.05em;
    }
    
    .theme-neon code, .theme-neon pre,
    .theme-neon [data-slot="code"] {
      font-family: var(--voila-font-mono);
    }
    
    /* Cyberpunk glow effects */
    .theme-neon .btn-primary,
    .theme-neon button[data-variant="primary"],
    .theme-neon [data-slot="button"][data-variant="primary"] {
    ...
    .theme-neon button[data-variant="primary"]:hover,
    .theme-neon [data-slot="button"][data-variant="primary"]:hover {
    ...
    .theme-neon.dark button[data-variant="primary"]:hover,
    .theme-neon.dark [data-slot="button"][data-variant="primary"]:hover {
      background: var(--voila-gradient-hover-dark);
    }
    
    /* Professional cards - clean and minimal */
    .theme-neon [data-slot="card"] {
      background: var(--color-card);
      transition: all 0.2s ease;
    }
    
    /* Thin light border for dark mode cards */
    .theme-neon.dark [data-slot="card"] {
      border: 1px solid oklch(0.35 0.03 150);
    }
    
    /* Cyberpunk text gradient */
    .theme-neon .text-gradient-primary {
  ...
  light: {
    ...
    primaryGradient: 'linear-gradient(135deg, oklch(0.29 0.035 150) 0%, oklch(0.42 0.05 150) 100%)',
  ...
  dark: {
    ...
    primaryGradient: 'linear-gradient(135deg, oklch(0.36 0.055 150) 0%, oklch(0.52 0.08 150) 100%)',
