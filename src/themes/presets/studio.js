...
const studioTheme = {
  ...
  light: {
    ...
    chart2: 'oklch(0.55 0.15 45)', // Creative amber
  ...
  dark: {
    ...
    card: 'oklch(0.06 0.008 270)',
    cardForeground: 'oklch(0.96 0.003 270)',
    popover: 'oklch(0.06 0.008 270)',
    popoverForeground: 'oklch(0.96 0.003 270)',
    primary: 'oklch(0.78 0.03 270)', // Light studio gray
    primaryForeground: 'oklch(0.04 0.005 270)',
    secondary: 'oklch(0.12 0.008 270)',
    secondaryForeground: 'oklch(0.94 0.005 270)',
    muted: 'oklch(0.08 0.006 270)',
    mutedForeground: 'oklch(0.74 0.005 270)',
    accent: 'oklch(0.75 0.18 45)', // Bright creative amber
    ...
    ring: 'oklch(0.78 0.03 270)',
    chart1: 'oklch(0.78 0.03 270)', // Light studio gray
    chart2: 'oklch(0.75 0.18 45)', // Bright creative amber
