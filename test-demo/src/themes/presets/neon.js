...
const neonTheme = {
  ...
  design: {
    ...
    radiusEnhance: '0.25rem',
    spacingEnhance: '0.9',
    shadowEnhance: '0 0 20px rgb(320 100% 50% / 0.3), 0 4px 16px rgb(0 0 0 / 0.15)',
    gradientPrimary: 'linear-gradient(135deg, oklch(0.45 0.28 320) 0%, oklch(0.65 0.25 180) 100%)',
    gradientSubtle: 'linear-gradient(135deg, oklch(0.45 0.28 320 / 0.1) 0%, oklch(0.65 0.25 180 / 0.05) 100%)',
    gradientHover: 'linear-gradient(135deg, oklch(0.45 0.28 320 / 0.9) 0%, oklch(0.65 0.25 180 / 0.9) 100%)',
    gradientText: 'linear-gradient(135deg, oklch(0.45 0.28 320) 0%, oklch(0.65 0.25 180) 100%)',
  },
